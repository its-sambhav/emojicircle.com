...
(function () {
  ...
  var headerHTML = [
    ...
    '        </a>',
    '        <a href="https://pin.it/6mgY7seJK" target="_blank" rel="noopener" aria-label="Pinterest">',
  ...
  var sidebarHTML = [
    ...
    '          <a href="/categories/smileys" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83D\uDE0A</span><span class="sidebar-text">Smileys</span></a>',
    '          <a href="/categories/people" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83D\uDC64</span><span class="sidebar-text">People</span></a>',
    '          <a href="/categories/animals" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83D\uDC3E</span><span class="sidebar-text">Animals</span></a>',
    '          <a href="/categories/food" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83C\uDF54</span><span class="sidebar-text">Food</span></a>',
    '          <a href="/categories/activity" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\u26BD</span><span class="sidebar-text">Activity</span></a>',
    '          <a href="/categories/travel" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83D\uDE80</span><span class="sidebar-text">Travel</span></a>',
    '          <a href="/categories/objects" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83D\uDCA1</span><span class="sidebar-text">Objects</span></a>',
    '          <a href="/categories/symbols" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83D\uDC96</span><span class="sidebar-text">Symbols</span></a>',
    '          <a href="/categories/flags" class="sidebar-link sidebar-link--sub"><span class="sidebar-icon">\uD83C\uDFF3\uFE0F</span><span class="sidebar-text">Flags</span></a>',
    '        </div>',
    '      </div>',
    '    </div>',
    '    <div class="sidebar-section sidebar-section--footer">',
    '      <span class="sidebar-section__label">More</span>',
    '      <a href="/pages/rules/privacy" class="sidebar-link">',
    '        <span class="sidebar-icon">\uD83D\uDCDC</span><span class="sidebar-text">Policies</span>',
    '      </a>',
    '      <a href="/pages/rules/about" class="sidebar-link">',
    '        <span class="sidebar-icon">\u2139\uFE0F</span><span class="sidebar-text">About</span>',
    '      </a>',
    '      <a href="/pages/rules/contact" class="sidebar-link">',
